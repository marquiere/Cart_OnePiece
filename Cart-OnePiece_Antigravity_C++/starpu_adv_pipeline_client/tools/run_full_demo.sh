...
./build/dataset_sanity --host 127.0.0.1 --port 2000 --w 800 --h 600 --fps 10 --frames 30 --engine models/dummy.engine --out_w 512 --out_h 256 --assume_bgra 1 --display 1 || echo "Extraction Failed!"
