...
# Blue: Simulation Environment Configuration
c1 = {'ec': '#2B6CB0', 'fc': '#EBF8FF', 'tfc': '#3182CE'}
# Green: Sensor Data Acquisition
c2 = {'ec': '#276749', 'fc': '#F0FFF4', 'tfc': '#38A169'}
# Purple: ADV Workload and Task Execution
c3 = {'ec': '#6B46C1', 'fc': '#FAF5FF', 'tfc': '#805AD5'}
# Dark Gray/Slate: Performance and Analysis Outputs
c4 = {'ec': '#4A5568', 'fc': '#F7FAFC', 'tfc': '#718096'}
# Orange: Synthetic Dataset Generation
c5 = {'ec': '#C05621', 'fc': '#FFFAF0', 'tfc': '#DD6B20'}
...
b1_t2 = "Configuration"
b1_body = "• Scenario definition and CARLA execution\n• Vehicle setup and sensor attachment\n• Selection of the desired ADV sensor suite"
draw_box(ax, xc, y1, w, h, b1_t1, b1_t2, b1_body, **{"ec": c1["ec"], "fc": c1["fc"], "title_fc": c1["tfc"]})

# Box 2
b2_t1 = "Sensor Data"
b2_t2 = "Acquisition"
b2_body = "• Collection of active sensor streams\n• Synchronized access to simulated data\n• Preparation of inputs for subsequent processing"
draw_box(ax, xc, y2, w, h, b2_t1, b2_t2, b2_body, **{"ec": c2["ec"], "fc": c2["fc"], "title_fc": c2["tfc"]})

# Box 3
b3_t1 = "ADV Workload and"
b3_t2 = "Task Execution"
b3_body = "• Generation of processing tasks from sensor data\n• Submission of tasks to StarPU for heterogeneous execution\n• Support for perception, localization, fusion, and control routines"
draw_box(ax, xc, y3, w+8, h+2, b3_t1, b3_t2, b3_body, **{"ec": c3["ec"], "fc": c3["fc"], "title_fc": c3["tfc"]})

# Box 4 (Branch Left)
x4 = xc - 24
b4_t1 = "Performance and"
b4_t2 = "Analysis Outputs"
b4_body = "• Latency, metrics, logs, and traces\n• Workload characterization artifacts\n• Comparative scheduling analyses"
draw_box(ax, x4, y4, w-2, h, b4_t1, b4_t2, b4_body, **{"ec": c4["ec"], "fc": c4["fc"], "title_fc": c4["tfc"]})

# Box 5 (Branch Right)
x5 = xc + 24
b5_t1 = "Synthetic Dataset"
b5_t2 = "Generation"
b5_body = "• Storage of simulated sensor outputs\n• Creation of reusable labeled data\n• Support for later training and validation"
draw_box(ax, x5, y4, w-2, h, b5_t1, b5_t2, b5_body, **{"ec": c5["ec"], "fc": c5["fc"], "title_fc": c5["tfc"]})
...
png_filename = '/home/eric/Cart_OnePiece/Cart-OnePiece_Antigravity_C++/Tese_Ericson/imagens/generic_workflow.png'
...
# -----------------------------------------------------------------------------
tex_filename = '/home/eric/Cart_OnePiece/Cart-OnePiece_Antigravity_C++/Tese_Ericson/imagens/generic_workflow.tex'
