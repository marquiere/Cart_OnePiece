...
% Capítulos
\include{texto/1-introducao}
\include{texto/2-background}
\include{texto/3-arte}
%\include{texto/2.2-arquiteturas}
\include{texto/4-metodologia}
\include{texto/5-Cart_OnePiece}
%\include{texto/5-conclusoes}
%\include{texto/6-schedule}
